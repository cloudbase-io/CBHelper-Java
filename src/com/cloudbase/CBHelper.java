...
public class CBHelper implements CBHelperResponder {
	...
	private void registerDevice() {
	    ...
	    device.put("device_name", this.deviceInfo.getDeviceName());
	    device.put("device_model", this.deviceInfo.getDeviceModel());
	    device.put("language", this.deviceInfo.getLanguage());
	    device.put("country", this.deviceInfo.getCountry());
	...
	private String getQueueFolder() {
		String queueFolder = this.temporaryFilesPath + File.separator + "cb_queue";
	...
	private Hashtable<String, String> preparePostParams(Object postData, Map<String, String> additionalParams) {
		...
		post.put("device_uniq", this.deviceInfo.getDeviceUniqueIdentifier());
		...
		if (this.useLocation && this.currentLocation != null)
		{
			...
			locData.put("lat", Double.toString(this.currentLocation.getLat()));
			locData.put("lng", Double.toString(this.currentLocation.getLng()));
			locData.put("alt", Double.toString(this.currentLocation.getAlt()));
	...
	public String getDeviceUniqueIdentifier() {
		return this.deviceInfo.getDeviceUniqueIdentifier();
	}
	...
	public void setDeviceUniqueIdentifier(String deviceUniqueIdentifier) {
		this.deviceInfo.setDeviceUniqueIdentifier(deviceUniqueIdentifier);
	}
	...
	public CBLocation getCurrentLocation() {
		return currentLocation;
	}

	public void setCurrentLocation(CBLocation currentLocation) {
